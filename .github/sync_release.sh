...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-MrJong_MiSTer.git"
CORE_NAME=(Arcade-MrJong)
...
UPSTREAM_CORE_NAME=(Arcade-MrJong)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(Arcade-MrJong.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-MrJong.rbf)
